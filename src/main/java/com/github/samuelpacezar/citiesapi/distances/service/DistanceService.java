package com.github.samuelpacezar.citiesapi.distances.service;
...
public class DistanceService {
    ...
    public Double distanceInKilometers(final Long city1, final Long city2) {
        log.info("distanceByCubeInMeters({}, {})", city1, city2);
        final List<City> cities = cityRepository.findAllById((Arrays.asList(city1, city2)));
        ...
        return cityRepository.distanceByCube(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 1000;
    }
